...
const MapComponent = ({ airports = [] }) => {
  ...
  console.log('Аэропорты для карты:', validAirports.length);
  if (validAirports.length > 0) {
    console.log('Пример координат первого аэропорта:', 
      validAirports[0]['Название аэропорта'],
      'Широта:', validAirports[0]['Широта'],
      'Долгота:', validAirports[0]['Долгота']
    );
  }
